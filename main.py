...
if __name__ == "__main__":
    ...
    parser.add_argument('--saved_path', type=str, default='./3npy_img/')
    parser.add_argument('--save_path', type=str, default='./4save/')
    # loader已改，此句失效
    ...
    parser.add_argument('--decay_iters', type=int, default=200)
    parser.add_argument('--save_iters', type=int, default=1000)
    parser.add_argument('--test_iters', type=int, default=2475)
    ...
    parser.add_argument('--load_pre', type=bool, default=False)
